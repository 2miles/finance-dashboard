...
from split_checking_descriptions import rebuild_merchant_lookup, split_checking_csv
...
def main() -> None:
    ...
    lookup_row_count, filled_lookup_row_count = rebuild_merchant_lookup(
        args.canonical_raw, args.lookup
    )
    split_checking_csv(args.canonical_raw, args.processed, args.lookup, keep_description=False)
